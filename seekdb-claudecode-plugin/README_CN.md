...
1. 在 `seekdb-plugin/skills` 目录下创建新的技能文件夹
...
seekdb-docs 的文档内容位于 `seekdb-plugin/skills/seekdb-docs/official-docs` 目录，可以根据 seekdb 官方文档的更新进行同步。
...
请参阅 [LEGAL.md](./LEGAL.md) 文件了解相关法律信息。
